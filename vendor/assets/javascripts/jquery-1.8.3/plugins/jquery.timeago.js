(function($, undefined) {
  ...
  //
  // Modified by Eric Faerber to not show relative times for dates over 7 days
  //
  ...
  (function() {
    ...
    TimeAgo = (function() {
      ...
      TimeAgo.prototype.timeAgoInWords = function(timeString) {
        ...
        var relTime = this.distanceOfTimeInWords(absolutTime);

        if (relTime === false) {
          return months[absolutTime.getMonth()] + ' ' + absolutTime.getDate() + ', ' + absolutTime.getFullYear();
        }
